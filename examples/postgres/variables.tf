...
variable "admin_username" {
  type        = string
  description = "Admin user name used to connect to the instance and manage grants. For a service-account admin on PostgreSQL, use the email without the \".gserviceaccount.com\" suffix."
  sensitive   = true
}
